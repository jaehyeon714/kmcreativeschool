...
public class PageFactory {
    ...
    public static String getPage(long cPage, long numPerpage, long totalData,
            String url) {
        return getPage(cPage, numPerpage, totalData, url, null, null);
    }

    public static String getPage(long cPage, long numPerpage, long totalData,
            String url, String condition, String keyword) {
        ...
        if (condition != null) {
            pageBar.append("&condition=" + condition);
        }
        if (keyword != null) {
            pageBar.append("&keyword=" + keyword);
        }
        pageBar.append("');");
        pageBar.append("}");
        pageBar.append("</script>");
